...
import com.company.orm.servicebuilder.model.impl.VacancyImpl;
import com.company.orm.servicebuilder.model.impl.VacancyModelImpl;
...
public class VacancyPersistenceImpl extends BasePersistenceImpl<Vacancy>
     ...
     */
    @Override
    public Vacancy create(String url) {
        Vacancy vacancy = new VacancyImpl();

        vacancy.setNew(true);
        vacancy.setPrimaryKey(url);
     ...
     */
    @Override
    public Vacancy remove(String url)
    ...
    protected Vacancy toUnwrappedModel(Vacancy vacancy) {
        ...
        vacancyImpl.setDateOfPublication(vacancy.getDateOfPublication());
        vacancyImpl.setOrganization(vacancy.getOrganization());
        vacancyImpl.setSalary(vacancy.getSalary());
        vacancyImpl.setUrl(vacancy.getUrl());
     ...
     */
    @Override
    public Vacancy findByPrimaryKey(String url)
        throws NoSuchVacancyException, SystemException {
     ...
     */
    @Override
    public Vacancy fetchByPrimaryKey(String url) throws SystemException {
    ...
    public void afterPropertiesSet() {
        String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
                    com.liferay.util.service.ServiceProps.get(
                        "value.object.listener.com.company.orm.servicebuilder.model.Vacancy")));
