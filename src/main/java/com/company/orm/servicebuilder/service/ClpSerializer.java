...
import com.company.orm.servicebuilder.model.VacancyClp;
...
public class ClpSerializer {
        ...
        synchronized (ClpSerializer.class) {
            ...
            try {
                ...
                String portletPropsServletContextName = (String) getMethod.invoke(null,
                        "infosystem-prod-case-portlet-deployment-context");
            ...
            if (Validator.isNull(_servletContextName)) {
                _servletContextName = "infosystem-prod-case-portlet";
            }
    ...
    public static Object translateOutput(BaseModel<?> oldModel) {
        ...
        if (oldModelClassName.equals(
                    "com.company.orm.servicebuilder.model.impl.VacancyImpl")) {
    ...
    public static Throwable translateThrowable(Throwable throwable) {
        ...
        if (className.equals(
                    "com.company.orm.servicebuilder.NoSuchVacancyException")) {
            return new com.company.orm.servicebuilder.NoSuchVacancyException();
        }
