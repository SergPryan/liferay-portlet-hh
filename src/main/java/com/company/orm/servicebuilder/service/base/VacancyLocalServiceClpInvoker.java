...
public class VacancyLocalServiceClpInvoker {
    ...
    public VacancyLocalServiceClpInvoker() {
        ...
        _methodName40 = "addVacancy";

        _methodParameterTypes40 = new String[] { "com.company.grabber.VacancyDto" };
    ...
    public Object invokeMethod(String name, String[] parameterTypes,
        ...
        if (_methodName0.equals(name) &&
            ...
            return VacancyLocalServiceUtil.addVacancy((com.company.orm.servicebuilder.model.Vacancy) arguments[0]);
        }

        if (_methodName1.equals(name) &&
                Arrays.deepEquals(_methodParameterTypes1, parameterTypes)) {
            return VacancyLocalServiceUtil.createVacancy((java.lang.String) arguments[0]);
        }

        if (_methodName2.equals(name) &&
                Arrays.deepEquals(_methodParameterTypes2, parameterTypes)) {
            return VacancyLocalServiceUtil.deleteVacancy((java.lang.String) arguments[0]);
        }

        if (_methodName3.equals(name) &&
                Arrays.deepEquals(_methodParameterTypes3, parameterTypes)) {
            return VacancyLocalServiceUtil.deleteVacancy((com.company.orm.servicebuilder.model.Vacancy) arguments[0]);
        }
        ...
        if (_methodName10.equals(name) &&
            ...
            return VacancyLocalServiceUtil.fetchVacancy((java.lang.String) arguments[0]);
        }

        if (_methodName11.equals(name) &&
                Arrays.deepEquals(_methodParameterTypes11, parameterTypes)) {
            return VacancyLocalServiceUtil.getVacancy((java.lang.String) arguments[0]);
        }
        ...
        if (_methodName15.equals(name) &&
            ...
            return VacancyLocalServiceUtil.updateVacancy((com.company.orm.servicebuilder.model.Vacancy) arguments[0]);
        }
        ...
        if (_methodName40.equals(name) &&
            ...
            return VacancyLocalServiceUtil.addVacancy((com.company.grabber.VacancyDto) arguments[0]);
        }

        if (_methodName42.equals(name) &&
                Arrays.deepEquals(_methodParameterTypes42, parameterTypes)) {
            return VacancyLocalServiceUtil.getAll();
        }
